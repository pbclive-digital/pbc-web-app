...
import pbcwebapp.ui_news.generated.resources.news_label_publish_confirmation
import pbcwebapp.ui_news.generated.resources.news_label_yes
import pbcwebapp.ui_news.generated.resources.news_phrase_publish_confirmation
...
private fun PublishConfirmationContent(onAgree: () -> Unit, onDisagree: () -> Unit) {
    Box (
        ...
        Column {
            Text(
                text = stringResource(Res.string.news_label_publish_confirmation),
                fontSize = 24.sp,
            ...
            Text(
                ...
                text = stringResource(Res.string.news_phrase_publish_confirmation),
                fontSize = 18.sp,
                fontFamily = PBCFontFamily,
