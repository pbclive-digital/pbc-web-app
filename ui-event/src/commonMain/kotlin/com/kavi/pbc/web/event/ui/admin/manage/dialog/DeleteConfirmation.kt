...
import pbcwebapp.ui_event.generated.resources.event_label_delete_confirmation
...
import pbcwebapp.ui_event.generated.resources.event_phrase_delete_confirmation
...
private fun DeleteConfirmationContent(onAgree: () -> Unit, onDisagree: () -> Unit) {
    Box (
        ...
        Column {
            Text(
                text = stringResource(Res.string.event_label_delete_confirmation),
                fontSize = 24.sp,
            ...
            Text(
                ...
                text = stringResource(Res.string.event_phrase_delete_confirmation),
                fontSize = 18.sp,
                fontFamily = PBCFontFamily,
